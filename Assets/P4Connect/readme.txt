...
Release Notes:
Last Update : October 26, 2015 by Norman Morse
...
Release Notes
-------------
Version 2015.3 Patch1
- Fixed exception in GetFileState()
- Fixed bad code in IsDirOrValidSubdirectoryOf()  Workspace roots are now correctly checked.

Version 2015.3/1263183
- Cleaned up some code
- Cleaned up some Doxygen comments
- Ignore directories during PostProcessor callback
- Added option to use Perforce server typemap (instead of P4Connect hard-wired typemap)
- Re-Added obfuscation of password in stored Preferences.
- File status requests are now handled asynchronously to avoid UI hangs.

Version 2015.2/1245676 (Patch1)
- Statically linked SSL libraries into OSX dylib to prevent wrong version issues.
- Fixed bug with persisting PerforceEnabled using EditorPrefs.   
- Fixed disconnect after run bug.
- Fixed problem with "Get Latest" from within the "Perforce" dialog
- Disabled dialog updates while game is running

Version 2015.2/1220452
